...
public class AudioPlayer {
    ...
    private MediaPlayer mPlayer; //Like VLC media player controls video/audio

    private AudioTrack mProgressTone;// controls audio file
    ...
    public void stopRingtone() {
        if (mPlayer != null) {
            mPlayer.stop();
            mPlayer.release();//since media player and audio player uses system resources more we have to relaease
            mPlayer = null;
        }
    }

    //progressTone is the dialer Tone
